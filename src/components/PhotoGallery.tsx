...
const extraPhotos: Photo[] = [
  { url: Pic4, caption: "BGMI Partnerss" },
  { url: Pic5, caption: "First Art Date" },
];
...
const TimelineComponent: React.FC<{ onProceed: () => void }> = ({ onProceed }) => {
  const timelineEvents = [
    { icon: "🌟", title: "Our First Date!", desc: "Lodhi Garden! (1/12/24)" },
    { icon: "💗", title: "Our First time Holding hands", desc: "Sunder Nursery (8/12/24)" },
    { icon: "🫂", title: "Our First Hug", desc: "Raj Ghat! (9/2/25)" },
    { icon: "✨", title: "To be continued...", desc: "So many more memories still to come." }
  ];
            ...
            <div className="flex flex-col justify-center space-y-10">
              ...
              <div className="relative mx-auto">
                ...
                <motion.button
                  ...
                  onClick={onComplete}
                >
                  I stitched some feelings into lines, just for you!❤️
                </motion.button>
              </div>
            </div>
          </div>

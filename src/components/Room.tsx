  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-20">
        <h1 className="text-3xl font-bold text-red-500 drop-shadow-lg">Ninni Tehni jaise Haatho ka Jalwa dikhaoo!</h1>
      ...
      {score >= REWARD_THRESHOLD && (
        ...
        >
          ...
          Chalo Jawline ka Jalwa Dikhane👉🏻👈🏻 →
        </motion.button>
      )}
    </motion.div>
  );
